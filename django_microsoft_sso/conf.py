...
MICROSOFT_SSO_ALLOWABLE_DOMAINS = getattr(
    settings, "MICROSOFT_SSO_ALLOWABLE_DOMAINS", []
)
...
MICROSOFT_SSO_AUTO_CREATE_USERS = getattr(
    settings, "MICROSOFT_SSO_AUTO_CREATE_USERS", True
)
